...
alias F="nvim ~/dotfiles/linux.config/foot/foot.ini"
alias G="nvim ~/.gitignore"
alias Gc="nvim ~/.gitconfig"
alias H="nvim ~/dotfiles/linux/.config/hypr/hyprland.conf"
alias M="nvim ~/dotfiles/base/.config/mise/config.toml"
alias N="nvim ~/dotfiles/base/.config/nvim"
