...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_COLN, KC_PERC, KC_PEQL, KC_BSLS, KC_TAB, KC_NO, KC_4, KC_5, KC_6, KC_NO, KC_PAST, KC_PPLS, KC_PMNS, KC_PSLS, KC_SPC, KC_DOT, KC_1, KC_2, KC_3, MT(MOD_RCTL,KC_0), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PCMM, KC_7, KC_8, KC_9, KC_RALT,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
