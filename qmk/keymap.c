...
#define XOURNAL_WHITE RCS(KC_D)
#define XOURNAL_ERASE RCS(KC_E)
#define XOURNAL_SELECT RCS(KC_R)
...
/////////////////////////////////////////////////
// NAV
const uint16_t PROGMEM app_fullscreen[] = {KC_A, KC_E, TH_SPC, COMBO_END};
...
// browser (gpt)
const uint16_t PROGMEM dictation[] = {TH_R, TH_SPC, COMBO_END};
...
combo_t key_combos[85] = {
    ...
    COMBO(app_fullscreen, APP_FULLSCREEN),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QUICK_FIRE] = LAYOUT_split_3x5_2(KC_VOLD, ZOOM_OUT, ZOOM_IN, KC_VOLU, KC_MUTE, KC_MUTE, A(KC_7), A(KC_8), A(KC_9), TM_PREV_SESS, SFT_TAB, GO_BACK, GO_FORWARD, TAB_TOGGLE, KC_TRNS, KC_TRNS, A(KC_1), A(KC_2), A(KC_3), EMOJIS, TM_WIN_NEW, TM_PANE_CLOSE, TG(_MOUSE_7SYMBOLS), APPLICATION_LAUNCHER, MS_BTN2, QK_BOOT, A(KC_4), A(KC_5), A(KC_6), KC_TRNS, MS_BTN1, MS_BTN2, MS_WHLD, MS_WHLU),

   // 🏗️ fn keys
  [_FN] = LAYOUT_split_3x5_2(FIG_MOVE, FIG_HIGHLIGHT, FIG_MARKER, FIG_ERASE, XOURNAL_CYAN, KC_F11, KC_F7, KC_F8, KC_F9, KC_F12, XOURNAL_GRAY, XOURNAL_NEON, XOURNAL_WHITE, XOURNAL_ORANGE, XOURNAL_RED, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F10, C(KC_A), XOURNAL_SELECT, MT(MOD_LALT, KC_DEL), XOURNAL_ERASE, XOURNAL_HAND, KC_TRNS, KC_F4, KC_F5, KC_F6, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
};
