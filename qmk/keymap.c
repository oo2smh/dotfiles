...
const uint16_t PROGMEM game_layer[] = {KC_G, KC_M, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_NO, KC_NO, KC_NO, KC_HOME, KC_END, C(S(KC_RBRC)), KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN2, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_RALT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[4] = LAYOUT_split_3x5_2(KC_1, KC_2, KC_3, KC_R, KC_T, KC_Y, KC_4, KC_5, KC_6, KC_P, KC_A, KC_S, KC_D, KC_F, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_E, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_TRNS KC_COMM, KC_DOT, KC_TRNS, KC_LSFT, KC_SPC, KC_BTN1, KC_BTN2),
};
