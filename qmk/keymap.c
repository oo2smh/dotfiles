...
const uint16_t PROGMEM mon_toggle[] = {KC_I, KC_E, KC_A, COMBO_END};
const uint16_t PROGMEM sys_toggle_r[] = {KC_H, KC_T, KC_N, COMBO_END};
...
// text edit: nvim
const uint16_t PROGMEM nv_pane_switch[] = {KC_H, KC_N, COMBO_END};
...
const uint16_t PROGMEM nv_a_reg_ins[] = {TH_SCRAPS, KC_P, COMBO_END};
const uint16_t PROGMEM nv_midline[] = {KC_H, QK_REP, KC_A, COMBO_END};
const uint16_t PROGMEM nv_zz[] = {TH_R, KC_F, COMBO_END};
...
combo_t key_combos[85] = {
    ...
    COMBO(ctl_l, C(KC_L)),
    COMBO(ctl_t, C(KC_T)),
    COMBO(sft_esc, S(KC_ESC)),
    COMBO(dictation_gpt, DICTATION_GPT),

    // TEXT MANIPULATION 12
    COMBO(nv_pane_switch, NV_PANE_SWITCH),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_T_SCRAPS] = LAYOUT_split_3x5_2(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_Z, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_V, KC_B, KC_J, KC_X, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_Q, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

  [_SYMBOLS] = LAYOUT_split_3x5_2(KC_AMPR, LABRC, RABRC, KC_BSLS, KC_TRNS, KC_TRNS, KC_DLR, KC_PEQL, KC_PPLS, KC_TRNS, KC_UNDS, KC_SCLN, KC_COLN, KC_SLSH, KC_TRNS, KC_TRNS, KC_LBRC, KC_LPRN, KC_LCBR, KC_DQUO, OSL(_ARROWS_NUMPAD), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_S, KC_RBRC, KC_RPRN, KC_RCBR, OSL(_FLOW_SYMBOLS), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  ...
  [_ARROWS_NUMPAD] = LAYOUT_split_3x5_2(S(KC_G), KC_7, KC_8, KC_9, KC_TRNS, KC_TRNS, KC_DLR, KC_PEQL, KC_PPLS, SUPER_F, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, KC_TRNS, KC_1, KC_2, KC_3, SFT0, KC_SPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_4, KC_5, KC_6, KC_TRNS, OSM(MOD_LSFT), KC_TRNS, MOVE_LEFT_WORD, MOVE_RIGHT_WORD),

  [_MOUSE_7SYMBOLS] = LAYOUT_split_3x5_2(MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR, MS_BTN2, KC_TRNS, OSM(MOD_RSFT), OSM(MOD_RALT), OSM(MOD_RCTL), SUPER_F, MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, KC_TRNS, KC_TRNS, KC_HASH, KC_PIPE, KC_GRV, KC_PERC, KC_SPC, KC_EXLM, KC_TRNS, KC_QUES, KC_TRNS, KC_TRNS, KC_CIRC, KC_TILDE, KC_AT, KC_TRNS, MT(MOD_LCTL, MS_BTN2), MS_BTN1, KC_TRNS, KC_TRNS),

  [_QUICK_FIRE] = LAYOUT_split_3x5_2(KC_VOLD, KC_VOLU, APP_FULLSCREEN, SYS_FULLSCREEN, KC_MUTE, TM_RN_WIN, TM1, TM2, TM3, TM_PREV_SESS, STAB_TOGGLE, GO_BACK, GO_FORWARD, TAB_TOGGLE, KC_TRNS, KC_TRNS, A(KC_1), A(KC_2), A(KC_3), EMOJIS, KC_TRNS, NV_PREV_HUNK, NV_NEXT_HUNK, APPLICATION_LAUNCHER, QK_BOOT, TM_PANE_CLOSE, A(KC_4), A(KC_5), A(KC_6), TM_WIN_NEW, MS_BTN1, MS_BTN1, MS_WHLD, MS_WHLU),
