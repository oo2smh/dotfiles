...
-- GENERAL UI
hl(0,"Normal", { fg = frappe.text ,bg = frappe.base })
hl(0,"PMenu", { fg = frappe.text ,bg = frappe.base })
hl(0,"NormalFloat", { fg = frappe.text ,bg = frappe.base })
hl(0,"ColorColumn", { bg = frappe.mantle})
...
hl(0, "@markup.heading.4",    { fg = frappe.lavender, })
