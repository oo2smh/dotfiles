  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "<leader>jr", "<cmd>Telescope lsp_references<CR>", opts) -- show definition, references

        opts.desc = "Go to declaration"
        keymap.set("n", "<leader>jd", vim.lsp.buf.declaration, opts) -- jump to declaration

        opts.desc = "Show LSP type definitions"
        keymap.set("n", "<leader>jt", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp type definitions
